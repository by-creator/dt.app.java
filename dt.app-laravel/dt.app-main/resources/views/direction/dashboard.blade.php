<x-layouts::app :title="__('Direction Générale')">
    @php
        $allowedRoles = ['DIRECTION_GENERALE', 'ADMIN', 'SUPER_U'];
        ...
        <section class="rounded-[1.5rem] border border-slate-200/70 bg-white/95 shadow-[0_20px_45px_-28px_rgba(15,23,42,0.45)] dark:border-slate-700/70 dark:bg-slate-900/95">
            @if ($canAccess)
                <div class="px-6 py-14 text-center">
                    ...
                    <h2 class="text-2xl font-semibold text-slate-800 dark:text-slate-100">Module Direction Générale</h2>
                    <p class="mx-auto mt-3 max-w-xl text-sm text-slate-500 dark:text-slate-400">
                        Bienvenue dans l'espace Direction Générale de Dakar Terminal.
                    </p>
                </div>
            @else
                <div class="px-6 py-14 text-center">
                    ...
                    <p class="mx-auto mt-3 max-w-xl text-sm text-slate-500 dark:text-slate-400">
                        Cette section est réservée au rôle DIRECTION_GENERALE.
                    </p>
                </div>
            @endif
        </section>
